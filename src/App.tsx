              ...
              <ul className="flex md:space-x-4 ">
                <li className="px-1 py-4 sm:px-4">
                  <a
                    ...
                    target="_blank"
                    className="flex items-center space-x-2 transition duration-200 underline decoration-transparent hover:decoration-indigo-400 underline-offset-4 decoration-2"
                  >
