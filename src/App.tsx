          ...
          <div className="min-h-screen w-3/5 flex flex-col text-white">
            <nav className="p-6 md:pr-10 font-semibold text-base flex justify-center sm:text-md md:text-lg lg:justify-end">
              <ul className="flex space-x-4">
                <li className="flex flex-row space-x-2 px-1 py-4 sm:px-4">
                  <a
                    href="https://linkedin.com/in/rtrinh760"
                    target="_blank"
                    className="pointer-events-auto xs:pointer-events-none"
                  >
                  ...
                  <a
                    href="https://linkedin.com/in/rtrinh760"
                    target="_blank"
                    className="flex items-center space-x-2 underline decoration-transparent hover:decoration-white underline-offset-2 decoration-2"
                  >
