        ...
        <div className="flex justify-center bg-[#1E1E1E]">
          <div className="min-h-screen w-3/5 flex flex-col text-white">
              ...
              <ul className="flex md:space-x-4 ">
                <li className="px-1 py-4 sm:px-4">
                  <a
                    ...
                    target="_blank"
                    className="flex items-center space-x-2 transition duration-200 underline decoration-transparent hover:decoration-[#d6d6d6] hover:text-[#d6d6d6] underline-offset-4 decoration-2"
                  >
            ...
            <div className="flex flex-col justify-center md:justify-start lg:ml-10 mt-5">
                ...
                <p>
                  ...
                  <p>
                    ...
                    <a
                      ...
                      target="_blank"
                      className="transition duration-200 underline decoration-transparent hover:decoration-[#d6d6d6] hover:text-[#d6d6d6] underline-offset-4 decoration-2"
                    >
                      Colby College
                    </a>
                    {" - "}
              ...
              <h2 className="font-bold my-8 text-xl md:text-2xl">Projects</h2>
              <div className="text-xl space-y-3 pb-10">
                <div>
                  <p>
                    <a
