// https://drive.google.com/file/d/1d2RfjsatcKRRyyIfMJtt9EPOOC8_tEV7/view

function App() {
  return (
    <>
      <div className="overflow-auto overscroll-y-none">
        <div className="flex flex-col justify-center bg-[#1E1E1E] pb-10">
          ...
          <iframe
            className="w-full h-[640px] w-100"
            src="https://drive.google.com/file/d/1d2RfjsatcKRRyyIfMJtt9EPOOC8_tEV7/preview"
          />
        </div>
      </div>
    </>
